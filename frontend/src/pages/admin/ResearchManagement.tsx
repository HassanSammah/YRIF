...
import {
  ...
  CheckCircle, XCircle, Globe, UserPlus, Eye, ChevronDown,
} from 'lucide-react'
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
        <h2 className="text-lg font-semibold text-[#093344] mb-1">Assign Reviewer</h2>
        <p className="text-sm text-gray-500 mb-4 line-clamp-1 italic">{research.title}</p>

        <label htmlFor="reviewer-select" className="block text-sm font-medium text-gray-700 mb-1.5">
          Reviewer (Mentor)
        </label>
        <div className="relative mb-3">
          <select
            ...
            className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#0D9488]/40 focus:border-[#0D9488] hover:border-gray-300 appearance-none pr-10 cursor-pointer disabled:opacity-60"
          >
            <option value="">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 rounded-xl bg-[#093344] hover:bg-[#0D9488] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 disabled:opacity-50"
          >
      ...
      <tr className="hover:bg-gray-50/50 transition-colors">
        <td className="px-4 py-3">
          <Link
            ...
            className="font-medium text-gray-900 hover:text-[#0D9488] line-clamp-1 text-sm block"
          >
            {research.title}
          </Link>
        ...
        <td className="px-4 py-3">
          <div className="flex items-center gap-1.5 justify-end flex-wrap">
            <Link
              to={`/research/${research.id}`}
              className="inline-flex items-center gap-1 rounded-xl border border-gray-200 bg-white text-gray-700 hover:border-[#0D9488] hover:text-[#0D9488] px-2 py-1 text-xs font-semibold shadow-sm transition-all duration-200"
            >
